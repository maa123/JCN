...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.JapariCoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("JapariCointools.com", "dnsseed.JapariCointools.com"));
        vSeeds.push_back(CDNSSeedData("JapariCoinpool.org", "dnsseed.JapariCoinpool.org"));
        ...
        fDefauJCNonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("JapariCointools.com", "testnet-seed.JapariCointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.JapariCoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        fDefauJCNonsistencyChecks = true;
        fRequireStandard = false;
