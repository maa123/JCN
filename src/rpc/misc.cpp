...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"JapariCoinaddress\"\n"
            "\nReturn information about the given JapariCoin address.\n"
            "\nArguments:\n"
            "1. \"JapariCoinaddress\"     (string, required) The JapariCoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"JapariCoinaddress\", (string) The JapariCoin address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"JapariCoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"JapariCoinaddress\"  (string, required) The JapariCoin address to use for the signature.\n"
